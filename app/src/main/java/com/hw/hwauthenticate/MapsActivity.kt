...
class MapsActivity : AppCompatActivity(), OnMapReadyCallback {
    ...
    companion object {
        ...
        fun showNotification1(context: Context?, message: String) {
    ...
    fun ReminderNotification(){
        val ret = RemindSQLiteHelper.searchRemindDataByID(remindID)
        var intent= Intent(this, MainActivity::class.java)
        val pendingIntent = PendingIntent.getActivity(this, 0, intent, PendingIntent.FLAG_UPDATE_CURRENT)
        showNotification(pendingIntent,ret)
    }

    fun showNotification(pendingIntent: PendingIntent, reminder: RemindSQLiteHelper.RemindData)
    {
